...
- 📉 **95% reduction** in release effort through parallel execution frameworks
- ⚡ **60% faster** dashboard load times via Django optimization
- 🔄 **93% faster** validation cycles with automated measurement workflows
- 🧪 **90%+ test coverage** on production backend systems
- 🏆 **1st place** in company-wide LabVIEW speed coding competition
...
I believe great software isn't just about writing code — it's about building **tools that empower teams**. There's something deeply satisfying about seeing a framework you built being used by 10+ engineers daily, or watching a dashboard you optimized load in milliseconds instead of seconds.

When I'm not coding, you'll find me volunteering with **Dublin City Volunteers** or geeking out over embedded systems projects.
...
<p align="center">
  <i>⭐ If you find any of my repos useful, a star would mean a lot! ⭐</i>
</p>
